...
from .pocketbase import create_job, get_job, update_job
...
async def track_job(job_id, request: Request, background_tasks: BackgroundTasks):
    ...
    return templates.TemplateResponse("job-tracker.html", {"request": request, **job_obj})
